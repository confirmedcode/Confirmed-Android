...
package com.trytunnels.android.utils.purchaseUtils;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    logDebug("Checking for in-app billing 5 support.");

                    // check for in-app billing v6 support
                    int response = mService.isBillingSupported(5, packageName, ITEM_TYPE_INAPP);
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(new IabResult(response,
                                "Error checking for billing v5 support."));
                    ...
                    logDebug("In-app billing version 6 supported for " + packageName);
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener listener, String extraData, String oldSku) {
        launchPurchaseFlow(act, sku, ITEM_TYPE_SUBS, requestCode, listener, extraData, oldSku);
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode,
        ...
        try {
            ...
            //Bundle buyIntentBundle = mService.getBuyIntentExtraParams(6, mContext.getPackageName(), sku, itemType, extraData, null);
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        {
            throw new IabException(0, "Being disposed?");
        }
        try {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException, IabException {
        ...
        {
            throw new IabException(0, "IabHelper disposed?");
        }
